...
public class GlobalUtils {
    ...
    private static Map<String,Integer> shortMonthToOrdinal = buildMonthMap();

    private static Map<String, Integer> buildMonthMap() {
        return Arrays.stream(Month.values()).collect(Collectors.toMap(month -> month.getDisplayName(TextStyle.SHORT,Locale.UK).toUpperCase(),
                Month::getValue));
    }
